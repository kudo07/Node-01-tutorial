// express will help to routing
let express = require("express");
let app = express();
let dotenv = require("dotenv");
// use in local to access the environment variable without package this line will not work
dotenv.config();
const fs = require("fs");
...
// it first check the environment variable
// app.use(morgan("tiny"));
// app.use(morgan("dev"));
// app.use(morgan("combined"));
// app.use(morgan("short"));
// req-> to write the logs in the one file
// var products = [
//   {
//     id: 1,
...
//   //   it will open default route of the producrs
// });
...
// });
// to achive this functionality we use the express router
